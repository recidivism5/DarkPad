...
rc res.rc
cl /nologo /O1 /w /Gz /GS- darkpad.c /link /nodefaultlib /subsystem:console kernel32.lib shell32.lib gdi32.lib user32.lib ole32.lib uuid.lib dwmapi.lib comdlg32.lib uxtheme.lib advapi32.lib msvcrt.lib res.res
